...
var HomePage = function () {
  ...
  // Login with facebook
  var facebook = element(by.xpath('//div[@class="col-xs-12 col-sm-12 col-md-7"]//button[@facebook-login-button="Facebook"]'))
  var fbAgreeBtn = element(by.xpath('//*[text()="Agree"]'))
  var fbEmail = element(by.id('email'))
  var fbPassword = element(by.id('pass'))
  var fbLogin = element(by.id('u_0_0'))
  var googlePlus = element(by.xpath('//div[@class="col-xs-12 col-sm-12 col-md-7"]//button[@google-plus-login-button="Google+"]'))
